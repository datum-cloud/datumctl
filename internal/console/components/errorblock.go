...
func RenderErrorBlock(b ErrorBlock) string {
	...
	titleStyle := lipgloss.NewStyle().Background(styles.Surface).Foreground(color).Bold(true)
	mutedStyle := lipgloss.NewStyle().Background(styles.Surface).Foreground(styles.Muted)
	accentStyle := lipgloss.NewStyle().Background(styles.Surface).Foreground(styles.Accent).Bold(true)
