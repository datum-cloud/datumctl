...
func (m HeaderModel) View() string {
	...
	case m.Ctx.Refreshing:
		frame := lipgloss.NewStyle().Foreground(styles.Warning).Bold(true).Render(m.Ctx.SpinnerFrame)
		label := lipgloss.NewStyle().Foreground(styles.Warning).Render(" refreshing…")
		refresh = frame + label
